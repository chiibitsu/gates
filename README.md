...
occurrences with the one you want from the Releases table above:
...
|---|---|---|
| **v1.0.4** | the merged head of #4 | **Yes — use this one.** Its `CITATION.cff` names the version on its tag — which v1.0.0 and v1.0.1 also did, and v1.0.2 and v1.0.3 did not. Gates byte-identical to v1.0.2 and v1.0.3, so it carries their one known false green, described below. |
